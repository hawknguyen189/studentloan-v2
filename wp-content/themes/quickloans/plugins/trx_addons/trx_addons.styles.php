...
if (!function_exists('quickloans_trx_addons_get_css')) {
	add_filter('quickloans_filter_get_css', 'quickloans_trx_addons_get_css', 10, 4);
	function quickloans_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
