...
if ( !function_exists( 'quickloans_woocommerce_get_css' ) ) {
	add_filter( 'quickloans_filter_get_css', 'quickloans_woocommerce_get_css', 10, 4 );
	function quickloans_woocommerce_get_css($css, $colors, $fonts, $scheme='') {
...
/* Buttons */
.quickloans_shop_mode_buttons a {
	color: {$colors['text_dark']};
}
.quickloans_shop_mode_buttons a:hover {
	color: {$colors['text_link']};
}
