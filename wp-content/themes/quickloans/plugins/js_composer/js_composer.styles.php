...
if ( !function_exists( 'quickloans_vc_get_css' ) ) {
	add_filter( 'quickloans_filter_get_css', 'quickloans_vc_get_css', 10, 4 );
	function quickloans_vc_get_css($css, $colors, $fonts, $scheme='') {
...
/* Tabs */
.vc_tta-color-grey.vc_tta-style-classic .vc_tta-tabs-list .vc_tta-tab > a .vc_tta-icon {
...
.vc_tta-color-grey.vc_tta-style-classic .vc_tta-tabs-list .vc_tta-tab > a:hover .vc_tta-icon,
.vc_tta-color-grey.vc_tta-style-classic .vc_tta-tabs-list .vc_tta-tab.vc_active > a .vc_tta-icon {
	color: {$colors['text_link2']};
}
