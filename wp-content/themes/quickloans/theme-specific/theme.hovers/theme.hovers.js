...
jQuery(document).on('action.init_hidden_elements', function(e, cont) {
	"use strict";
	if (QUICKLOANS_STORAGE['button_hover'] && QUICKLOANS_STORAGE['button_hover']!='default') {
		jQuery('button:not(.search_submit):not(.pswp__button):not([class*="sc_button_hover_"]),\
				...
				.quickloans_tabs .quickloans_tabs_titles li a:not([class*="sc_button_hover_"]),\
				...
				').addClass('sc_button_hover_just_init sc_button_hover_'+QUICKLOANS_STORAGE['button_hover']);
		if (QUICKLOANS_STORAGE['button_hover']!='arrow') {
		...
		jQuery('.sidebar .trx_addons_tabs .trx_addons_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
				.quickloans_tabs .quickloans_tabs_titles li a:not([class*="sc_button_hover_style_"])\
		...
		jQuery('.mejs-controls button,\
				...
				').removeClass('sc_button_hover_'+QUICKLOANS_STORAGE['button_hover']);
