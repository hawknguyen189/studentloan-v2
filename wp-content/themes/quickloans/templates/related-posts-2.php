...
?><div id="post-<?php the_ID(); ?>" 
	<?php post_class( 'related_item related_item_style_2 post_format_'.esc_attr($quickloans_post_format) ); ?>><?php
	...
	?><div class="post_header entry-header"><?php
		if ( in_array(get_post_type(), array( 'post', 'attachment' ) ) ) {
			?><span class="post_date"><a href="<?php echo esc_url($quickloans_link); ?>"><?php echo quickloans_get_date(); ?></a></span><?php
		}
		?>
		<h6 class="post_title entry-title"><a href="<?php echo esc_url($quickloans_link); ?>"><?php echo the_title(); ?></a></h6>
	</div>
</div>